Gem::Specification.new do |s|
  ...
  s.files = [ 'History.txt', 'License.txt', 'README.txt', 'Rakefile',
              'lib/ruby-mythtv.rb', 'mythtv/backend.rb', 'mythtv/database.rb',
              'mythtv/epg.rb', 'mythtv/protocol.rb', 'mythtv/recording.rb',
              'mythtv/schedule.rb', 'mythtv/utils.rb',
              'test/test_backend.rb', 'test/test_helper.rb' ]
  s.has_rdoc = true
